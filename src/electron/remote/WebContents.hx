...
@:jsRequire("electron", "remote.WebContents") extern class WebContents extends js.node.events.EventEmitter<electron.remote.WebContents> {
	...
	**/
	static function getFocusedWebContents():haxe.extern.EitherType<electron.remote.WebContents, Dynamic>;
	/**
		A WebContents instance with the given ID, or `undefined` if there is no WebContents associated with the given ID.
	**/
	static function fromId(id:Int):haxe.extern.EitherType<electron.remote.WebContents, Dynamic>;
	/**
	...
	**/
	static function fromFrame(frame:electron.remote.WebFrameMain):haxe.extern.EitherType<electron.remote.WebContents, Dynamic>;
	/**
	...
	**/
	static function fromDevToolsTargetId(targetId:String):haxe.extern.EitherType<electron.remote.WebContents, Dynamic>;
	/**
...
var to : Float; }>; /**
	...
	**/
	function getMediaSourceId(requestWebContents:electron.remote.WebContents):String;
	/**
